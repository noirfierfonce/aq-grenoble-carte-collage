...
209 points vérifiés, tous citycode 38185.

- Compacité actuelle : **70.98 km²**.
- Compacité proposition : **34.81 km²**.
- Gain : **51.0 %**.
- Changements proposés : **23**.

## Tailles et rayons moyens

|Circuit|Actuel|Proposé|Moy. actuel|Moy. proposé|Max actuel|Max proposé|
|---|---:|---:|---:|---:|---:|---:|
...
|H – Point 01|H|J|0.51 km|Rue Léon JOUHAUX face N°1, boulevard CLEMENCEAU, Grenoble, France|
...
|A – Point 13|A|B|0.25 km|Esplanade ANDRY-FARCY N°5 (face au Magasin), Grenoble, France|
...
## Affectations atypiques actuelles (autre centroïde ≥ 350 m plus proche)

|Point|Actuel|Plus proche|Écart|Adresse|
|---|---:|---:|---:|---|
...
Méthode : distances géographiques locales aux centroïdes, optimisation conservative avec 13 à 19 points par circuit. Aucun circuit de production n’est modifié.
