...
Le dépôt contient uniquement les informations nécessaires à la carte terrain : nom du point, adresse publique, circuit, zone et recommandation couleur / noir et blanc. Il ne contient aucun nom d’équipe, numéro de téléphone, adresse mail, note interne, statut de passage ni lien privé vers le tableau de suivi.
...
- Aucun outil d’analytics ou de suivi.

Le tableau Google Sheets opérationnel reste séparé et privé.
